...
public class MapThreeModule extends Map {
    ...
    public MapThreeModule() {
        ...
        setFinish(new CheckPoint("map_3_finish", new WPoint(3804.5, 205, 110.5), 90.0F, 0F));
    }

    @Override
    protected void setupCheckpoints() {
        checkPoints.add(new CheckPoint("map_3_cp1", WPoint.from(3735.5, 196, 110.5), 90.0F, 0F));
        checkPoints.add(new CheckPoint("map_3_cp2", WPoint.from(3555.5, 196, 161.5), -90.0F, 0F));
        checkPoints.add(new CheckPoint("map_3_cp3", WPoint.from(3643.5, 196, 161.5), -90.0F, 0F));
        checkPoints.add(new CheckPoint("map_3_cp4", WPoint.from(3755.5, 196, 161.5), -90.0F, 0F));
        checkPoints.add(new CheckPoint("map_3_cp5", WPoint.from(3856.5, 196, 120.5), 180F, 0F));
        checkPoints.add(new CheckPoint("map_3_cp6", WPoint.from(3817.5, 206, 31.5), 90F, 0F));
        checkPoints.add(new CheckPoint("map_3_cp7", WPoint.from(3720.5, 206, 15.5), 135f, 0F));
        checkPoints.add(new CheckPoint("map_3_cp8", WPoint.from(3624.5, 206, 5.5), 90f, 0F));
        checkPoints.add(new CheckPoint("map_3_cp9", WPoint.from(3563.5, 212, -67.5), -90f, 0F));
        checkPoints.add(new CheckPoint("map_3_cp10", WPoint.from(3686.5, 199, -62.5), -90f, 0F));
    }
    ...
    protected void setupObstacles() {
        ...
        ClockArmsHolder clockArms = new ClockArmsHolder(
                ...
                ClockArms.of(WLocation.from(3679, 196, 161), 6.3, 90),
                ClockArms.of(WLocation.from(3699, 196, 161), 6.3, 90)
        );
