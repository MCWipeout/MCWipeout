...
//
//                Team obstacleTeam = scoreboard.getTeam("obstacle");
//                obstacleTeam.setSuffix(format("&f" + (plugin.getObstacleBar().getObstacleIndex().get(player.getUniqueId()) == null ? plugin.getGameManager().getActiveMap().getObstacles().size() :  plugin.getObstacleBar().getObstacleIndex().get(player.getUniqueId()) + "/" + plugin.getGameManager().getActiveMap().getObstacles().size())));
//
//                Team timeTeam = scoreboard.getTeam("timeElapsed");
